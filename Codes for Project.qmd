...
labs(x = "Highest Year of School Completed",
         ...
         title = "Distribution of participants' general happiness with different highest year of school completed")
...
labs(y = "Number of Observations",
         x = "General Happiness",
         title = "Distribution of participants' general happiness with different work force status, adjusted for gender") +
...
labs(y = "Number of Observations",
         x = "General Happiness",
         title = "Distribution of participants' general happiness with different total family income") +
...
labs(y = "Number of Observations",
         x = "General Happiness",
         title = "Distribution of participants' general happiness with different number of household members under 17") +
...
m2 <- lm(Happy ~ as.factor(workstat) + educ + young_members + as.factor(income) + 
           female + as.factor(income)*young_members,
         data = Happiness)
summary(m2)
```
