...
```
interpretations:
interpret the slope for female (compared to male) and workstatus (full time), then conduct a hypothesis test investigating whether there is an interaction between working status and being a woman. 
